...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          20, FIGHTING,     100, 15,   0
	...
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         120, NORMAL,      100, 10,   0
	...
	move BIND,         EFFECT_TRAP_TARGET,        35, NORMAL,        90, 20,   0
	...
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   35, BUG,          100, 20,  36
	...
	move STRENGTH,     EFFECT_ATTACK_UP_HIT,      80, NORMAL,       100, 15,  20
	move ABSORB,       EFFECT_LEECH_HIT,          30, GRASS,        100, 25,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          55, GRASS,        100, 15,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        35, FIRE,          90, 20,   0
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        50, WATER,         90, 10,   0
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     55, NORMAL,       100, 35, 100
	...
	move TRIPLE_KICK,  EFFECT_MULTI_HIT,          25, FIGHTING,      90, 10,   0
	...
	move PROTECT,      EFFECT_PROTECT,             0, NORMAL,       100,  5,   0
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  75, WATER,        100, 10, 100
	...
	move ROLLOUT,      EFFECT_ROLLOUT,            30, ROCK,          95, 20,   0
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       120, FIGHTING,      50,  5, 100
	...
	move SWEET_SCENT,  EFFECT_CONFUSE,             0, NORMAL,        75, 20,   0
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         75, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,         95, 35,  20
	...
	move WHIRLPOOL,    EFFECT_MULTI_HIT,          25, WATER,         90, 15,   0
