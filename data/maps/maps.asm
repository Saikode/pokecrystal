...
MapGroup_CableClub:
	...
	map Pokecenter2FRestArea, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SPECIAL, MUSIC_POKEMON_CENTER, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_TCG_IMAKUNI, FALSE, PALETTE_DAY, FISHGROUP_SHORE
